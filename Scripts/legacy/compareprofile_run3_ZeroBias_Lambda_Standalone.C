...
void readHistograms(vector<string>& v, const char* filename="lambdaProfile_run3_standalone.txt");
...
void compareHisto(const vector<TFile*>& v, const char* folder, const char* hname) 
{
  for (uint i = 0; i < v.size(); ++i) {
    TFile* f = v[i];
    if (i==0) f->cd("DQMData/Run 278509/StandaloneTrackMonitor/Run summary/LambdaTracks/");
    if (i==1) f->cd("DQMData/Run 278509/StandaloneTrackMonitor/Run summary/LambdaTracks/");
...
// TString h_title = "2016B_preVFP Run 278509 : " + tokens[3] + " Vs " + tokens[2];
  ...
  for (uint i = 0; i < v.size(); ++i) {
    ...
    //if ( i==1) f->cd("DQMData/Run 278509/StandaloneTrackMonitor/Run summary/LambdaTracks/");
    if (i==2) f->cd("DQMData/Run 1/StandaloneTrackMonitor/Run summary/LambdaTracks/");
...
// TString h_title = "2016B_preVFP Run 278509 : " + tokens[3] + " Vs " + tokens[2];
  ...
  for (uint i = 0; i < v.size(); ++i) {
    ...
    //if ( i==1) f->cd("DQMData/Run 278509/StandaloneTrackMonitor/Run summary/LambdaTracks/");
    if (i==4) f->cd("DQMData/Run 1/StandaloneTrackMonitor/Run summary/LambdaTracks/");

...
void readHistograms(vector<string>& v, const char* filename="ElectronHistolist_run3.txt");
...
void compareHisto(const vector<TFile*>& v, const char* folder, const char* hname) 
{
  for (uint i = 0; i < v.size(); ++i) {
    TFile* f = v[i];
    //f->cd(folder);
    if (i==0) f->cd("DQMData/Run 999999/StandaloneTrackMonitor/Run summary/ElectronTracks/");
    if (i==1) f->cd("DQMData/Run 999999/StandaloneTrackMonitor/Run summary/ElectronTracks/");
    if (i==2 || i==3 || i==4) f->cd("DQMData/Run 1/StandaloneTrackMonitor/Run summary/ElectronTracks/");
    //if (i==1) f->cd("DQMData/Run 1/StandaloneTrackMonitor/Run summary/ElectronTracks/");
...
void compareHisto(TCanvas* canvas, const vector<TFile*>& v, const vector<string>& lglist, const vector<string>& tokens, const string& yr) 
{
  ...
  if (yr == "2016pre") {
    datafolder = "DQMData/Run 278509/StandaloneTrackMonitor/Run summary/ElectronTracks/";
    yearinfo   = "2016 Old APV settings"; 
    luminfo    = "0.30 fb^{-1} (13 TeV)";
  } 
  else if (yr == "2016post") {
    datafolder = "DQMData/Run 278808/StandaloneTrackMonitor/Run summary/ElectronTracks/";
    yearinfo   = "2016 New APV settings"; 
    luminfo    = "0.28 fb^{-1} (13 TeV)";
  } 
  else if (yr == "2017") {
    datafolder = "DQMData/Run 999999/StandaloneTrackMonitor/Run summary/ElectronTracks/";
    yearinfo   = "Z#rightarrowee"; 
    luminfo    = "17.9 fb^{-1} (13.6 TeV)"; //Modify to show the correct integrated luminosity
  } 
  else if (yr == "2018") {
    datafolder = "DQMData/Run 317626/StandaloneTrackMonitor/Run summary/ElectronTracks/";
    yearinfo   = "2018"; 
...
//  TString h_title = "Run 275376 : " + tokens[2];
  ...
  for (uint i = 0; i < v.size(); ++i) {
    ...
    //if (i==1) f->cd("DQMData/Run 999999/StandaloneTrackMonitor/Run summary/ElectronTracks/"); // EOY data
    if (i==2 ) f->cd("DQMData/Run 1/StandaloneTrackMonitor/Run summary/ElectronTracks/"); // UL & EOY MC
    //if (i==1) f->cd("DQMData/Run 1/StandaloneTrackMonitor/Run summary/ElectronTracks/");
  ...
  //f_eoyd->cd("DQMData/Run 999999/StandaloneTrackMonitor/Run summary/ElectronTracks/");  
  ...
  for (uint i = 0; i < v.size(); ++i) {
    ...
    TFile* f = v[i];
    //f->cd(folder.c_str());
    //if (i==0) f->cd("DQMData/Run 999999/StandaloneTrackMonitor/Run summary/ElectronTracks/"); // UL data
    if (i==1) f->cd(datafolder.c_str()); // EOY data
    if (i==4) f->cd("DQMData/Run 1/StandaloneTrackMonitor/Run summary/ElectronTracks/"); // UL & EOY MC
    //if (i==1) f->cd("DQMData/Run 1/StandaloneTrackMonitor/Run summary/ElectronTracks/");
    TH1F *h = dynamic_cast<TH1F*>(gDirectory->Get(hname.c_str()));
  ...
  */
  ...
  for (uint i = 2; i < v.size(); ++i) {
    ...
    //here i=0 will never be opened    //if (i==0) f->cd("DQMData/Run 251143/StandaloneTrackMonitor/Run summary/ElectronTracks/");
    if (i==2) file->cd("DQMData/Run 1/StandaloneTrackMonitor/Run summary/ElectronTracks/"); 
    //if (i==1) file->cd("DQMData/Run 1/StandaloneTrackMonitor/Run summary/ElectronTracks/");
  ...
  for (uint i = 2; i < v.size(); ++i) {
    ...
    //file->cd(folder.c_str());
    //here i=0 will never be opened    //if (i==0) f->cd("DQMData/Run 251143/StandaloneTrackMonitor/Run summary/ElectronTracks/");
    if (i==4) file->cd("DQMData/Run 1/StandaloneTrackMonitor/Run summary/ElectronTracks/"); 
    //if (i==1) file->cd("DQMData/Run 1/StandaloneTrackMonitor/Run summary/ElectronTracks/");
    TH1F *h2 = dynamic_cast<TH1F*>(gDirectory->Get(hname.c_str()));
    if (!h2) continue;
  ...
  TFile* f_ulm = v.at(2);
  //f->cd(folder.c_str());                                                                                                                           
  f_ulm->cd("DQMData/Run 1/StandaloneTrackMonitor/Run summary/ElectronTracks/");
...
void openFiles(vector<TFile*>& v1, vector<string>& v2, const char* filename, const string& yr ) {
  ...
  else if (yr == "2017") filename = "filelist13p6TeV_ZEE.txt";

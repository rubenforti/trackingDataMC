...
void readHistograms(vector<string>& v, const char* filename="ElectronHistolist_ZEEDetails.txt");
...
void compareHisto(const vector<TFile*>& v, const char* folder, const char* hname) 
{
  for (uint i = 0; i < v.size(); ++i) {
    TFile* f = v[i];
    //f->cd(folder);
    if (i==0) f->cd("DQMData/Run 999999/ZEEDetails/Run summary/ElectronTracks/");
    if (i==1) f->cd("DQMData/Run 999999/ZEEDetails/Run summary/ElectronTracks/");
    if (i==2 || i==3 || i==4) f->cd("DQMData/Run 1/ZEEDetails/Run summary/ElectronTracks/");
    //if (i==1) f->cd("DQMData/Run 1/ZEEDetails/Run summary/ElectronTracks/");
...
void compareHisto(TCanvas* canvas, const vector<TFile*>& v, const vector<string>& lglist, const vector<string>& tokens, const string& yr) 
{
  ...
  if (yr == "2016pre") {
    datafolder = "DQMData/Run 278509/ZEEDetails/Run summary/ElectronTracks/";
    yearinfo   = "2016 Old APV settings"; 
    luminfo    = "0.30 fb^{-1} (13 TeV)";
  } 
  else if (yr == "2016post") {
    datafolder = "DQMData/Run 278808/ZEEDetails/Run summary/ElectronTracks/";
    ...
    datafolder = "DQMData/Run 317626/ZEEDetails/Run summary/ElectronTracks/";
    yearinfo   = "2018"; 
...
//  TString h_title = "Run 275376 : " + tokens[2];
  ...
  for (uint i = 0; i < v.size(); ++i) {
    ...
    //if (i==1) f->cd("DQMData/Run 999999/ZEEDetails/Run summary/ElectronTracks/"); // EOY data
    if (i==2 ) f->cd("DQMData/Run 1/ZEEDetails/Run summary/ElectronTracks/"); // UL & EOY MC
    //if (i==1) f->cd("DQMData/Run 1/ZEEDetails/Run summary/ElectronTracks/");
  ...
  //f_eoyd->cd("DQMData/Run 999999/ZEEDetails/Run summary/ElectronTracks/");  
  ...
  for (uint i = 0; i < v.size(); ++i) {
    ...
    TFile* f = v[i];
    //f->cd(folder.c_str());
    //if (i==0) f->cd("DQMData/Run 999999/ZEEDetails/Run summary/ElectronTracks/"); // UL data
    if (i==1) f->cd(datafolder.c_str()); // EOY data
    if (i==4) f->cd("DQMData/Run 1/ZEEDetails/Run summary/ElectronTracks/"); // UL & EOY MC
    //if (i==1) f->cd("DQMData/Run 1/ZEEDetails/Run summary/ElectronTracks/");
    TH1F *h = dynamic_cast<TH1F*>(gDirectory->Get(hname.c_str()));
  ...
  */
  ...
  for (uint i = 2; i < v.size(); ++i) {
    ...
    //here i=0 will never be opened    //if (i==0) f->cd("DQMData/Run 251143/ZEEDetails/Run summary/ElectronTracks/");
    if (i==2) file->cd("DQMData/Run 1/ZEEDetails/Run summary/ElectronTracks/"); 
    //if (i==1) file->cd("DQMData/Run 1/ZEEDetails/Run summary/ElectronTracks/");
  ...
  for (uint i = 2; i < v.size(); ++i) {
    ...
    //file->cd(folder.c_str());
    //here i=0 will never be opened    //if (i==0) f->cd("DQMData/Run 251143/ZEEDetails/Run summary/ElectronTracks/");
    if (i==4) file->cd("DQMData/Run 1/ZEEDetails/Run summary/ElectronTracks/"); 
    //if (i==1) file->cd("DQMData/Run 1/ZEEDetails/Run summary/ElectronTracks/");
    TH1F *h2 = dynamic_cast<TH1F*>(gDirectory->Get(hname.c_str()));
    if (!h2) continue;
  ...
  TFile* f_ulm = v.at(2);
  //f->cd(folder.c_str());                                                                                                                           
  f_ulm->cd("DQMData/Run 1/ZEEDetails/Run summary/ElectronTracks/");

...
void readHistograms(vector<string>& v, const char* filename="highpurityProfile_run3.txt");
...
// TString h_title = "2016B_preVFP Run 278509 : " + tokens[3] + " Vs " + tokens[2];
  ...
  for (uint i = 0; i < v.size(); ++i) {
    ...
    //if ( i==1) f->cd("DQMData/Run 278509/StandaloneTrackMonitor/Run summary/highPurityTracks/");
    if (i==4) f->cd("DQMData/Run 1/StandaloneTrackMonitor/Run summary/highPurityTracks/");

...
void readHistograms(vector<string>& v, const char* filename="ElectronProfile_run3.txt");
...
void compareHisto(const vector<TFile*>& v, const char* folder, const char* hname) 
{
  for (uint i = 0; i < v.size(); ++i) {
    TFile* f = v[i];
    if (i==0) f->cd("DQMData/Run 278509/StandaloneTrackMonitor/Run summary/ElectronTracks/");
    if (i==1) f->cd("DQMData/Run 278509/StandaloneTrackMonitor/Run summary/ElectronTracks/");
...
void compareHisto(TCanvas* canvas, const vector<TFile*>& v, const vector<string>& lglist, const vector<string>& tokens, const string& yr) 
{
  ...
  if (yr == "2016pre") {
    ...
    luminfo    = "17.9 fb^{-1} (13.6 TeV)"; //Modify to have the correct integrated luminosity
  }
  else if (yr == "2018") {
...
// TString h_title = "2016B_preVFP Run 278509 : " + tokens[3] + " Vs " + tokens[2];
  ...
  for (uint i = 0; i < v.size(); ++i) {
    ...
    //if ( i==1) f->cd("DQMData/Run 278509/StandaloneTrackMonitor/Run summary/ElectronTracks/");
    if (i==2) f->cd("DQMData/Run 1/StandaloneTrackMonitor/Run summary/ElectronTracks/");
...
// TString h_title = "2016B_preVFP Run 278509 : " + tokens[3] + " Vs " + tokens[2];
  ...
  for (uint i = 0; i < v.size(); ++i) {
    ...
    //if ( i==1) f->cd("DQMData/Run 278509/StandaloneTrackMonitor/Run summary/ElectronTracks/");
    if (i==4) f->cd("DQMData/Run 1/StandaloneTrackMonitor/Run summary/ElectronTracks/");

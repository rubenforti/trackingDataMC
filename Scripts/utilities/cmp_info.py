...
yr_info_zerobias = yr_info_base | {
    "2025C": "2025, 141.8 nb^{-1} (13.6 TeV)",
    "2025E": " 2025, 87.3 nb^{-1} (13.6 TeV)",
    "2025G": "2025, 138.9 nb^{-1} (13.6 TeV)",
}
...
yr_info_lepton = yr_info_base | {
    ...
    "2025C": "2025, 21.9 fb^{-1} (13.6 TeV)",
    "2025E": "2025, 14.0 fb^{-1} (13.6 TeV)",
    "2025G": "2025, 22.2 fb^{-1} (13.6 TeV)",
}

...
void pileupreweight() {
    ...
    // DATA
    string fname_data = "../Data/json_data/pileUp_75300ub_2024I_Golden.root";
    ...
    // Output
    string fname_out = "/eos/home-r/rforti/trackingPOG/analyses_2024/MC/ZeroBias/SingleNeutrino_Par-E-10-gun/raw/PileupScaleFactor_999999_wrt_trueNInt_75300ub_Run2024I_golden.root";
    ...
    TH1* h1 = dynamic_cast<TH1*>(file1->Get("pileup"));	
    h1->SetName("pileup_data");
    cout << "1st histo " << h1->GetName() << " opened successfully" << endl;

    TH1* h2 = dynamic_cast<TH1*>(file2->Get("DQMData/Run 1/StandaloneTrackMonitor/Run summary/highPurityTracks/trueNInt"));
    ...
    TFile* f1 = TFile::Open(out_file.c_str(), "RECREATE");

...
void trackreweight() {
    ...
    string histName = "trackEta";
    string histPath = "StandaloneTrackMonitor/Run summary/highPurityTracks/" + histName;
    ...
    //string fname_data = "/eos/home-r/rforti/trackingPOG/analyses_2025/data/ZMM/Run2025G_golden_cmssw-15-0-15/DQM_V0001_R000999999__Global__CMSSW_X_Y_Z__RECO.root";
    ...
    //string fname_mc = "/eos/home-r/rforti/trackingPOG/analyses_2024/MC/ZMM/DYto2Mu-4Jets_Bin-MLL-50_RunIIISummer24DRPremix/nvtx_reweighted_2025G_golden/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root";
    // Out
    string fname_out = "../MC/ZeroBias/EtaScaleFactor_999999_Run2025G_golden.root";
    ...
    TH1* h1 = dynamic_cast<TH1*>(file1->Get(("DQMData/Run 999999/" + histPath).c_str()));	
    h1->SetName("trackQnt_data");
    cout << "1st histo " << h1->GetName() << " opened successfully" << endl;

    TH1* h2 = dynamic_cast<TH1*>(file2->Get(("DQMData/Run 1/" + histPath).c_str()));
    h2->SetName("trackQnt_mc");
    ...
    TH1F* hn = new TH1F("trackweight", "Track Weight Factor", nbinsx2, xmin2, xmax2);

...
void vertexreweight() {
    ...
    // DATA
    string fname_data = "/eos/home-r/rforti/trackingPOG/analyses_2025/data/ZeroBias/Run2025G_golden_cmssw-15_0_15/DQM_V0001_R000999999__Global__CMSSW_X_Y_Z__RECO.root";
    
    // MC
    string fname_mc = "/eos/home-r/rforti/trackingPOG/analyses_2024/MC/ZeroBias/SingleNeutrino_Par-E-10-gun/raw/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root";

    // Outout
    string fname_out = "../MC/ZeroBias/PileupScaleFactor_999999_wrt_nVertex_Run2025G_golden.root";
    ...
    TH1* h1 = dynamic_cast<TH1*>(file1->Get("DQMData/Run 999999/StandaloneTrackMonitor/Run summary/highPurityTracks/nVertex"));	
    h1->SetName("nvertex_data");
    cout << "1st histo " << h1->GetName() << " opened successfully" << endl;

    TH1* h2 = dynamic_cast<TH1*>(file2->Get("DQMData/Run 1/StandaloneTrackMonitor/Run summary/highPurityTracks/nVertex"));

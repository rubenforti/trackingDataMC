...
config.General.requestName = 'ZEE_2024G_golden_1' #PUT A REQUEST NAME
...
config.Data.inputDataset = '/EGamma1/Run2024G-PromptReco-v1/AOD' #TO BE MODIFIED TO ACTUALLY SELECT YOU REQUIRED DATASET (CAN ALSO BE RECO)

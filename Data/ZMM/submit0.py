...
config.General.requestName = 'ZMM_2024G_golden_0' #PUT A REQUEST NAME
...
config.Data.inputDataset = '/Muon0/Run2024G-PromptReco-v1/AOD' #TO BE MODIFIED TO ACTUALLY SELECT YOU REQUIRED DATASET (CAN ALSO BE RECO)
